(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".methods__slider")) new core(".methods__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    window.onscroll = function() {
        ...
        if (scrolled >= 1) document.querySelector(".heading").style.display = "none"; else document.querySelector(".heading").style.display = "block";
    };
    window["FLS"] = true;
    isWebp();
    menuInit();
